...
function getRegistrySnapshot() {
  ...
  "projects": [
    ...
    },
    {
      ...
      "missingItems": "",
      "lastVerified": "2026-05-10",
      "readyForLive": "Pending user verification of DEV v51 admin login alias fix",
      "promotionStatus": "",
      "lastDevChange": "Baseline release tracking initialized 2026-05-14.",
      "promotionNotes": "LIVE and DEV baseline set to registry release v1.",
      "dataSourceAudit": "REVIEW: API AppFolio found, but CSV/legacy fallback signals also found",
      "scriptAudit": "ACCESSIBLE",
      "auditNotes": "Batch 1 governance normalization: LIVE v305 verified. PMB DEV link corrected and updated to DEV v51 admin login alias fix on 2026-07-01.",
      "deployments": [
        {
          "registryRow": 8,
          "env": "LIVE",
